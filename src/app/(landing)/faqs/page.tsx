...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Vous pouvez réserver directement en ligne depuis notre page 'À venir' en sélectionnant l'événement de votre choix. Les paiements sont sécurisés et vous recevrez instantanément vos billets par e-mail.",
  },
  {
    question:
      "Proposez-vous des options végétariennes ou adaptées aux allergies ?",
    answer:
      "Absolument. Pour chaque événement ou menu classique, notre Chef conçoit des alternatives adaptées. Veuillez simplement nous préciser vos restrictions alimentaires ou allergies dans la section 'Notes' lors de votre réservation.",
  },
  {
    question:
      "Quelle est votre politique d'annulation pour les soirées spéciales ?",
    answer:
      "Les places pour nos événements exclusifs étant très limitées, les annulations sont remboursables intégralement jusqu'à 48 heures avant le début de l'événement. Passé ce délai, aucun remboursement ne pourra être effectué.",
  },
  {
    question: "Puis-je privatiser le restaurant pour un événement privé ?",
    answer:
      "Oui, notre salle et notre équipe peuvent être entièrement privatisées pour des mariages, anniversaires ou événements d'entreprise. Contactez notre équipe via le bouton d'appel pour obtenir un devis sur-mesure.",
  },
  {
    question: "Y a-t-il un parking ou un accès facile à proximité ?",
    answer:
      "Le restaurant dispose d'un espace de stationnement réservé à notre clientèle juste devant l'établissement. La liste complète des accès et des transports en commun est disponible sur notre page 'Nous trouver'.",
  },
];
            ...
            <div className="relative z-10 flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-neutral-500 leading-relaxed mt-1">
                  Si vous avez une demande particulière ou des questions
                  concernant une privatisation, réservez un appel avec notre
                  responsable.
                </p>
              </div>
              ...
              >
                ...
                <div
                  className={`grid transition-all duration-300 ease-in-out ${
                    isOpen
                      ? "grid-rows-[1fr] border-t border-[#F5EFE6]"
                      : "grid-rows-[0fr]"
                  }`}
                >

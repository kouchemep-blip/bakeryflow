...
export default function Deconnexion() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#100c0a] px-5 py-8">
      ...
      <main className="relative z-10 w-full max-w-sm rounded-sm border border-[#c9a15c]/35 bg-gradient-to-b from-[#241a15] to-[#1a130f] px-9 py-10 text-center shadow-[0_30px_70px_rgba(0,0,0,0.55)]">
        ...
        <button
          onClick={logout}
          disabled={loading}
          className="inline-flex w-full items-center justify-center gap-2 rounded-sm bg-gradient-to-b from-[#e6c98a] to-[#c9a15c] px-6 py-3.5 text-[0.85rem] font-medium uppercase tracking-[0.12em] text-[#1a130f] shadow-[0_8px_18px_rgba(201,161,92,0.25)] transition-all hover:-translate-y-px hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0"
        >
          {loading && (

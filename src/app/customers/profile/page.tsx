...
export default async function ProfilePage() {
  ...
  return <section className="space-y-6"><div><h1 className="text-3xl font-bold">Mon profil</h1><p className="mt-2 text-gray-500">Membre depuis le {user.createdAt.toLocaleDateString("fr-FR")}</p></div><ProfileForm profile={{ ...user, phone: user.phone ?? "" }} /></section>;
}

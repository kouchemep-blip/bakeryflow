      ...
      <AnimatePresence mode="wait">
        {orders.length === 0 ? (
          <motion.div
            ...
            className="flex flex-col items-center gap-3 rounded-[28px] border border-dashed border-slate-300 bg-[#F5F1EA] p-12 text-center"
          >
            ...
            {orders.map((order) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-[28px] border border-slate-100 bg-[#F5F1EA] p-5 shadow-sm"
                >

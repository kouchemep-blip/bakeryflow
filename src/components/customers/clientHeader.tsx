...
export default function ClientHeader({ user, pageTitle }: Props) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-white/[0.08] bg-[#161310]/90 px-4 backdrop-blur md:px-6">
      <div className="flex items-center gap-3">
        ...
        {pageTitle && (
          <h1 className="text-base font-semibold text-[#F5F1EA] md:text-lg">
            {pageTitle}
          </h1>
        )}
      </div>
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.06] px-3 py-1.5 text-sm font-medium text-[#F5F1EA] transition hover:bg-white/[0.1]"
        >
          ...
          <div className="absolute right-0 mt-2 w-56 rounded-xl border border-white/[0.12] bg-[#161310] p-2 shadow-xl">
            ...
            <nav className="py-2">
              <Link
                ...
                className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-[#A8A29B] transition hover:bg-white/[0.06] hover:text-[#F5F1EA]"
